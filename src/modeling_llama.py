...
class LlamaMLP(nn.Module):
    ...
    def forward(self, x):
        ...
        #     gate_proj_slices = self.gate_proj.weight.split(slice, dim=0)[rank]
        #     up_proj_slices = self.up_proj.weight.split(slice, dim=0)[rank]
        #     down_proj_slices = self.down_proj.weight.split(slice, dim=1)[rank]
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        #     logits = [F.linear(hidden_states, lm_head_slices[i]) for i in range(len(lm_head_slices))]
